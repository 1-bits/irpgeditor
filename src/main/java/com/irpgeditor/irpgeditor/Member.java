...
import com.irpgeditor.irpgeditor.env.QcmdexecOutput;
...
public class Member {
    ...
    public Member(AS400System as400system, String library, String file, String member) {
        ...
        this.member = DOUBLE_QUOTE.concat(member.trim().toUpperCase()).concat(DOUBLE_QUOTE);
        getInfo();
    }
    ...
    public String getName() {
        return member.replaceAll(DOUBLE_QUOTE, "");
    }
    ...
    public final void getInfo() {
        ...
        try {
            ...
            pcml.setValue("qusrmbrd.memberName", getName());
